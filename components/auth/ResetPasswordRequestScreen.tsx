          ...
          {success ? (
            <>
              ...
              <p className="muted mt-2">
                If an account exists for {trimmed}, you&apos;ll receive a password reset link shortly. The link opens a
                Project Planner page where you choose a new password.
              </p>
            ...
            <>
              ...
              <p className="muted mt-1.5">
                Enter your email and we&apos;ll send a reset link. Check spam if you don&apos;t see it.
              </p>
              {(error || localError) ? (
